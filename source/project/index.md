...
- **[monokai-pro.nvim](https://github.com/taotao7/monokai-pro.nvim)** - Monokai Pro theme for Neovim with multiple filters (Pro, Classic, Machine, Octagon, Ristretto, Spectrum, Sun)
- **[i18n.nvim](https://github.com/taotao7/i18n.nvim)** - i18n preview and management plugin for Neovim
- **[cassette-futurism-nvim](https://github.com/taotao7/cassette-futurism-nvim)** - Cassette futurism theme for Neovim
...
- **[just-music](https://github.com/taotao7/just-music)** - Simple and lightweight music player
- **[ffmpeg-server](https://github.com/taotao7/ffmpeg-server)** - Build video from image and audio using FFmpeg
- **[file-tree](https://github.com/taotao7/file-tree)** - Returns all files in the selected directory after selection
- **[tongyi-js-sdk](https://github.com/taotao7/tongyi-js-sdk)** - Tongyi AI JavaScript SDK
- **[userscript-template](https://github.com/taotao7/userscript-template)** - Userscript template for personal projects

## Themes

- **[cassette-futurism](https://github.com/taotao7/cassette-futurism)** - Cassette futurism theme collection
- **[cassette-futurism-windows-terminal-theme](https://github.com/taotao7/cassette-futurism-windows-terminal-theme)** - Cassette futurism Windows Terminal theme
